...
public class TourPackageDetailActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tour_package_detail);

        tourPackage = TourPackageData.tourPackageList().get(getIntent().getIntExtra(EXTRA_PARAM_ID, 0));
    ...
    private void loadTourPackage() {
        mTitle.setText(tourPackage.title);
        mImageView.setImageResource(tourPackage.getImageResourceId(this));
    }
    ...
    private void getPhoto() {
        Bitmap photo = BitmapFactory.decodeResource(getResources(), tourPackage.getImageResourceId(this));
        colorize(photo);
    }
